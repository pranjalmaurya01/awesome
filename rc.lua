...
local myawesomemenu = {
    ...
    { "edit config", terminal .." code '~/.config/awesome/rc.lua'" },
    { "restart", awesome.restart },
    { "quit", function() awesome.quit() end }
}
awful.util.mymainmenu = freedesktop.menu.build({
    icon_size = beautiful.menu_height or dpi(100),
    before = {
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "BackSpace", function () os.execute("systemctl suspend") end,
                {description = "lock screen", group = "hotkeys"}),
    ...
    awful.key({ modkey }, "w", function () awful.spawn("code-insiders") end,
    ...
    awful.key({ modkey }, "r", function () awful.screen.focused() awful.spawn.with_shell("dmenu_run -fn 'Inconsolata 10' -nb '#000000' -i") end,
...
-- awful.spawn.with_shell("nitrogen --random ~/wallpapers --set-centered")
